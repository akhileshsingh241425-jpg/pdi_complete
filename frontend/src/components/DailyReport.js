...
function DailyReport() {
  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/generate-production-report', payload, {
        responseType: 'blob'
      });
  ...
  const handleGenerateExcel = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/generate-production-excel', payload, {
        responseType: 'blob'
      });
