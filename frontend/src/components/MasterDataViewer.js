...
const MasterDataViewer = () => {
  ...
  const fetchModules = async () => {
    ...
    try {
      ...
      let url = `http://backend.gspl.cloud/api/master/modules/${selectedOrder}?limit=${modulesPerPage}&offset=${offset}`;
  ...
  const deleteModule = async (moduleId) => {
    ...
    try {
      const response = await fetch(`http://backend.gspl.cloud/api/master/module/${moduleId}`, {
        method: 'DELETE'
      });
  ...
  const deleteOrder = async (orderId) => {
    ...
    try {
      const response = await fetch(`http://backend.gspl.cloud/api/master/order/${orderId}`, {
        method: 'DELETE'
      });
  ...
  const updateModule = async () => {
    try {
      const response = await fetch(`http://backend.gspl.cloud/api/master/module/${editModule.id}`, {
        method: 'PUT',
